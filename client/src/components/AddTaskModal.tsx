...
//         <Dialog.Panel className="bg-white rounded-md shadow-lg p-6 w-full max-w-md">
...
//               Cancel
//             </button>
//             <button onClick={handleAddTask} className="px-4 py-2 bg-blue-600 text-white rounded-md">
//               Add Task
//             </button>
//           </div>
//         </Dialog.Panel>
